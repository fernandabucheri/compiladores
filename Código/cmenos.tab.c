...
{
       0,    35,    35,    38,    48,    51,    53,    56,    64,    74,
      81,    88,    99,   103,   107,   120,   125,   134,   144,   157,
     161,   165,   169,   182,   187,   200,   205,   209,   213,   217,
     221,   226,   230,   234,   240,   249,   256,   260,   266,   272,
     277,   281,   288,   294,   299,   304,   309,   314,   319,   324,
     330,   336,   341,   346,   352,   358,   363,   368,   374,   378,
     382,   386,   391,   398,   405,   418,   423,   429
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "PLUS", "MINUS", "TIMES", "OVER", "LESSTHAN", "LESSTHANEQUAL",
  "GREATERTHAN", "GREATERTHANEQUAL", "EQUAL", "NOTEQUAL", "ASSIGN", "SEMI",
  "COMMA", "LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "LKEY", "RKEY",
  "ID", "NUM", "ENDFILE", "ERROR", "$accept", "program",
  "declaration_list", "declaration", "variable_declaration",
  "specifier_type", "function_declaration", "parameters", "parameter_list",
  "parameter", "compound_declaration", "local_declarations",
  "statement_list", "statement", "expression_decl", "if_decl", "loop_decl",
  "return_decl", "expression", "var", "simple_expression", "relational",
  "sum_expression", "sum", "term", "mult", "factor", "activation",
  "argument_list", "identifier", "number", YY_NULLPTR
};
#endif
...
#line 1438 "cmenos.tab.c"
    break;

  case 4:
#line 49 "cmenos.y"
                                     { yyval = yyvsp[0]; }
#line 1444 "cmenos.tab.c"
    break;

  case 5:
#line 52 "cmenos.y"
                                { yyval = yyvsp[0]; }
#line 1450 "cmenos.tab.c"
    break;

  case 6:
#line 54 "cmenos.y"
                                { yyval = yyvsp[0]; }
#line 1456 "cmenos.tab.c"
    break;
...
#line 57 "cmenos.y"
                        {
                            ...
                            yyvsp[-1]->kind.statement = VariableK;
                            yyvsp[-1]->specifier_type = yyvsp[-2]->specifier_type;
			}
#line 1468 "cmenos.tab.c"
    break;
...
#line 89 "cmenos.y"
                       {
                            ...
                            yyvsp[-4]->nodekind = StatementK;
                            yyvsp[-4]->kind.statement = FunctionK;
                            yyvsp[-4]->specifier_type = yyvsp[-5]->specifier_type;
                       }
#line 1515 "cmenos.tab.c"
    break;
...
#line 126 "cmenos.y"
                       {
                           ...
                           yyvsp[0]->kind.statement = ParameterK;
                           yyvsp[0]->specifier_type = yyvsp[-1]->specifier_type;

                       }
#line 1568 "cmenos.tab.c"
    break;
...
#line 135 "cmenos.y"
                        {
                            ...
                            yyvsp[-2]->kind.expression = VectK;
                            yyvsp[-2]->kind.statement = ParameterK;
                            yyvsp[-2]->specifier_type = yyvsp[-3]->specifier_type;
                       }
#line 1581 "cmenos.tab.c"
    break;
...
#line 1726 "cmenos.tab.c"
    break;

  case 33:
#line 235 "cmenos.y"
                       {
                             yyval = newStatementNode(IfK);
                             yyval->child[0] = yyvsp[-2];
                             yyval->child[1] = yyvsp[0];
                       }
#line 1736 "cmenos.tab.c"
    break;
...
#line 1748 "cmenos.tab.c"
    break;

  case 35:
#line 250 "cmenos.y"
                       {
                             yyval = newStatementNode(WhileK);
                             yyval->child[0] = yyvsp[-2];
                             yyval->child[1] = yyvsp[0];
                       }
#line 1758 "cmenos.tab.c"
    break;

  case 36:
#line 257 "cmenos.y"
                       {
                            yyval = newStatementNode(ReturnK);
                       }
#line 1766 "cmenos.tab.c"
    break;
...
#line 1775 "cmenos.tab.c"
    break;

  case 38:
#line 267 "cmenos.y"
                       {
                            yyval = newStatementNode(AssignK);
                            yyval->child[0] = yyvsp[-2];
                            yyval->child[1] = yyvsp[0];
                       }
#line 1785 "cmenos.tab.c"
    break;
...
#line 282 "cmenos.y"
                       {
                            yyval = yyvsp[-3];
                            yyval->child[0] = yyvsp[-1];
                            yyval->kind.expression = VectK;
                       }
#line 1811 "cmenos.tab.c"
    break;
...
#line 310 "cmenos.y"
                       {
                            yyval = newExpressionNode(OpK);
                            yyval->attr.op = LESSTHAN;                            
                       }
#line 1856 "cmenos.tab.c"
    break;
...
#line 315 "cmenos.y"
                       {
                            yyval = newExpressionNode(OpK);
                            yyval->attr.op = LESSTHANEQUAL;                            
                       }
#line 1865 "cmenos.tab.c"
    break;
...
#line 320 "cmenos.y"
                       {
                            yyval = newExpressionNode(OpK);
                            yyval->attr.op = GREATERTHAN;                            
                       }
#line 1874 "cmenos.tab.c"
    break;
...
#line 325 "cmenos.y"
                       {
                            yyval = newExpressionNode(OpK);
                            yyval->attr.op = GREATERTHANEQUAL;                            
                       }
#line 1883 "cmenos.tab.c"
    break;
...
#line 392 "cmenos.y"
                       {
                            ...
                            yyval->kind.statement = CallK;
                       }
#line 1998 "cmenos.tab.c"
    break;
...
#line 2033 "cmenos.tab.c"
    break;

  case 66:
#line 424 "cmenos.y"
                       {
                             yyval = newExpressionNode(IdK);
                             yyval->attr.name = copyString(tokenString);
                       }
#line 2042 "cmenos.tab.c"
    break;

  case 67:
#line 430 "cmenos.y"
                       {
                             yyval = newExpressionNode(ConstantK);
                             yyval->attr.val = atoi(tokenString);
                       }
#line 2051 "cmenos.tab.c"
    break;


#line 2055 "cmenos.tab.c"
